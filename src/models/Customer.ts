...
export default class Customer {
    ...
    updatedOn: Date;
    note: string;
    constructor(id: number, code: string, name: string, email: string, phoneNumber: string, address: string, gender: boolean, birthday: Date, totalExpense: number, numberOfOrder: number, orders: Order[], createdOn: Date, updatedOn: Date, note: string) {
        this.id = id;
        this.code = code;
        this.name = name;
        this.email = email;
